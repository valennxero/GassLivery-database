...
INSERT INTO `cancelorder` VALUES (1,55,'Pengemudi Terlalu Lama'),(1,62,'Berubah Pikiran'),(1,63,'Mau Mengubah Tujuan'),(1,64,'Driver ketiduran'),(1,73,'Pengemudi Terlalu Lama'),(2,57,'Mau Mengubah Tujuan'),(2,58,'Mau Mengubah Tujuan'),(2,59,'Pengemudi Galak'),(2,60,'Mau Mengubah Tujuan'),(2,61,'Mau Mengubah Tujuan');
...
INSERT INTO `driver` VALUES (1,'supri','Male',4.5,1,1,0,'supri','123'),(2,'melati','Female',3.6,2,1,5810,'melati','321'),(3,'mita','Female',4.142857142,3,1,13600,'mita','123');
...
INSERT INTO `gass-mon` VALUES (1,99575210,5110),(2,0,0),(11,0,0),(12,0,0),(13,0,0),(14,0,0),(15,0,0),(16,0,0),(17,0,0),(18,0,0),(19,0,0),(20,0,0),(21,0,0),(22,0,0),(23,0,0),(24,0,0),(25,0,0),(26,0,0);
...
INSERT INTO `konsumen` VALUES (1,'Female',812,'Sinta','sinta','123',1),(2,'Male',1233,'Anto','anto','111',2),(14,'Female',NULL,'val','val','321',11),(15,'Female',1290,'siti','siti','321',12),(17,'Male',9333,'udin','udin','123',14),(18,'Male',789,'sumanto','sumanto','123',15),(19,'Male',234,'deni','deni','123',16),(20,'Male',NULL,'jev','all','222',18),(22,'Male',NULL,'jev','brave','222',21),(24,'Male',NULL,'jev','lor','222',22),(25,'Male',NULL,'jev','dino','222',25),(26,'Male',987,'rizal','rizal','123',26);
...
CREATE TABLE `menu` (
  ...
  `notaDetailId` int(11) NOT NULL,
  `tenantId` int(11) NOT NULL,
  PRIMARY KEY (`idMenu`),
  KEY `fk_Menu_NotaGassDetail1_idx` (`notaDetailId`),
  KEY `fk_Menu_Tenant1_idx` (`tenantId`),
  CONSTRAINT `fk_Menu_NotaGassDetail1` FOREIGN KEY (`notaDetailId`) REFERENCES `notafooddetail` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `motor` VALUES (1,'honda',6,NULL,'L 223 XY'),(2,'beat',3,NULL,'L5656 AB'),(3,'supra',1,NULL,'W 638 CC');
...
INSERT INTO `penarikandana` VALUES (1,30000,'2026-01-12 00:00:00',0),(2,60000,'0000-00-00 00:00:00',0),(3,200000,'2026-01-12 16:20:24',0),(4,60000,'2026-01-12 16:22:34',0),(5,40000,'2026-01-12 16:23:48',0),(6,100000,'2026-01-12 16:24:45',0),(7,100000,'2026-01-12 16:24:48',0),(8,16500000,'2026-01-13 15:53:50',0);
...
INSERT INTO `rating` VALUES (1,1,1,5),(2,1,1,4),(3,1,2,1),(4,1,2,2),(5,1,2,5),(6,1,3,3),(7,1,2,5),(8,1,3,4),(9,1,2,5),(10,1,3,3),(11,1,3,5),(12,1,3,5),(13,1,3,5),(14,1,3,4);
...
INSERT INTO `report` VALUES (1,1,72,NULL,0),(2,1,74,NULL,0);
...
INSERT INTO `waktu` VALUES (1,6,2000,7),(2,16,2000,17),(3,0,1000,5),(4,8,1000,15),(5,18,1000,24);
...
-- Dump completed on 2026-01-15 12:40:23
